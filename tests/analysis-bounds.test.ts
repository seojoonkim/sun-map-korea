...
test("point analysis keeps provider queries bounded to a local 900m neighborhood", () => {
  const bounds = createAnalysisBounds([127.02713, 37.4974]);
  assert.ok(bounds[2] - bounds[0] < 0.021);
  assert.ok(bounds[3] - bounds[1] <= 0.0160000001);
